...
train=fread('redhat_data_new/act_train_new_try2.csv') %>% as.data.frame()
test=fread('redhat_data_new/act_test_new_try2.csv') %>% as.data.frame()
...
writeMM(train.sparse,file='dtrain_sparse')
writeMM(test.sparse,file='dtest_sparse')