...
train=fread('redhat_data_new/act_train.csv') %>% as.data.frame()
test=fread('redhat_data_new/act_test.csv') %>% as.data.frame()
...
write.csv(sub, file = "model_sub_98035.csv", row.names = F)
